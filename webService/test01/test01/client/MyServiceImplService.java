 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://service.test01/", wsdlLocation = "http://localhost:7777/test01?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://service.test01/", "MyServiceImplService");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://service.test01/", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.test01/", "MyServiceImplPort"), IMyService.class, features);
    }

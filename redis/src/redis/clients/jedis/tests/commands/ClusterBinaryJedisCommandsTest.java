...
public class ClusterBinaryJedisCommandsTest {
  ...
  public void setUp() throws InterruptedException {
    node1 = new Jedis("192.168.186.133", 6379);
    node1.auth("foobared");
    node1.flushAll();

    node2 = new Jedis("192.168.186.133", 6380);
    node2.auth("foobared");
    node2.flushAll();

    node3 = new Jedis("192.168.186.133", 6381);
    node3.auth("foobared");
    node3.flushAll();
    ...
    node1.clusterMeet("192.168.186.133", 6380);
    node1.clusterMeet("192.168.186.133", 6381);
    ...
    jedisClusterNode.add(new HostAndPort("192.168.186.133", 7379));

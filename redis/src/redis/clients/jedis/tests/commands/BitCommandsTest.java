...
public class BitCommandsTest extends JedisCommandTestBase {
  ...
  public void bitpos() {
     ...
     */
    //00110001 00000100 00000000 00000000 00000001
    long offset = jedis.bitpos(foo, true);
    assertEquals(2, offset);
    offset = jedis.bitpos(foo, false);
    assertEquals(0, offset);

    offset = jedis.bitpos(foo, true, new BitPosParams(1));//从第一个字节开始查找
  ...
  //相比较上一个例子而言，key为二进制而已，存储的初始值也为0
  @Test

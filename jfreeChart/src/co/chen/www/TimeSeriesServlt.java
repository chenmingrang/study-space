 ...
 * @data 2017年3月19日
 */
public class TimeSeriesServlt extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		JFreeChart localJFreeChart = ChartFactory.createTimeSeriesChart("Time Series Demo 8", "Date", "Value", createDataset(), true, true, false);
	    ...
	    List localList = (List) Arrays.asList(new Integer[] { new Integer(0), new Integer(1) });
	    localXYPlot.mapDatasetToRangeAxes(0, localList);
	    
	    localXYPlot.getDomainAxis().setStandardTickUnits(DateAxis.createStandardDateTickUnits());

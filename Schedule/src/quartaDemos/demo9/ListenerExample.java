...
public class ListenerExample {
  ...
  public void run() throws Exception {
    ...
    //job2 begin in 15 seconds  
    Date startime=DateBuilder.nextGivenSecondDate(null, 15);
    job=newJob(SimpleJob1.class).withIdentity("job2","group1").build();
    trigger=newTrigger().withIdentity("trigger2", "group1").startAt(startime).build();
    // Set up the listener
